...
public class XmlReportMakerTest {
    ...
    @Test
    public void generateXmlFromListOfObjectTest(){
        ...
        XmlReportMaker xmlReportMaker = new XmlReportMaker(objectFactory);
        Assertions.assertNotEquals("",xmlReportMaker.generate());
